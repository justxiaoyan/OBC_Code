...
#define version_string "13.3.0"
#define pkgversion_string "(Buildroot -gb3f1f2fee5) "
...
#define bug_report_url "<https://gitlab.com/buildroot.org/buildroot/-/issues>"

#define GCOV_VERSION ((gcov_unsigned_t)0x4233332a)  /* B33* */
